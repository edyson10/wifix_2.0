...
public class ListarVentaAlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_venta_al);

        progressDialog = new ProgressDialog(ListarVentaAlActivity.this);
        listaVentas = (ListView) findViewById(R.id.listVentasAl);
    ...
    public String listarVentasGET() {
        ...
        String url_local = "http://192.168.1.6/ServiciosWeb/listarVentas2.php";
        String url_aws = "http://18.228.235.94/wifix/ServiciosWeb/listarVentas2.php";
