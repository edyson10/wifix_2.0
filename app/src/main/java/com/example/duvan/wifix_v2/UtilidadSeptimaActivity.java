...
public class UtilidadSeptimaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_utilidad_septima);

        progressDialog = new ProgressDialog(UtilidadSeptimaActivity.this);
        listaUtilidad = (ListView) findViewById(R.id.listUtilidadSep);
    ...
    public String listarVentasGET() {
        ...
        String url_aws = "http://18.228.235.94/wifix/ServiciosWeb/utilidad3.php";
