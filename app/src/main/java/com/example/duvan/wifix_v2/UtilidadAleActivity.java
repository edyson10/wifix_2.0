...
public class UtilidadAleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_utilidad_ale);

        progressDialog = new ProgressDialog(UtilidadAleActivity.this);
        listaUtilidad = (ListView) findViewById(R.id.listUtilidadAl);
    ...
    public String listarVentasGET() {
        ...
        String url_local = "http://192.168.1.6/ServiciosWeb/utilidad2.php";
        String url_aws = "http://18.228.235.94/wifix/ServiciosWeb/utilidad2.php";
