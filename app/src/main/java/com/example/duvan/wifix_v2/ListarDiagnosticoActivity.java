...
public class ListarDiagnosticoActivity extends AppCompatActivity {

    ListView listaDiagnostico;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_diagnostico);

        progressDialog = new ProgressDialog(ListarDiagnosticoActivity.this);
        listaDiagnostico = (ListView) findViewById(R.id.listDiagnostico);
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (validar == 0) {
                                ...
                                Toast.makeText(getApplicationContext(), "No hay ningún servicio registrado.", Toast.LENGTH_SHORT).show();
                            } else {
                                progressDialog.dismiss();
                                cargarLista(listarServicioDia((resultado)));
                                Toast.makeText(getApplicationContext(), "Se han cargado los diagnosticos exitosamente.", Toast.LENGTH_SHORT).show();
                                ...
                                listaDiagnostico.setAdapter(adapter);
                            }
                        }
                    });
                }
    ...
    public String listarServiciosGET(){
        ...
        String url_local = "http://192.168.1.6/ServiciosWeb/listarDiagnostico.php";
        String url_aws = "http://18.228.235.94/wifix/ServiciosWeb/listarDiagnostico.php";
        ...
        try{
            ...
            for (int i = 0;i<jsonArray.length();i++){
                if (jsonArray.getJSONObject(i).getString("estado").equalsIgnoreCase("1")) {
                    estado = "En revisión";
                } else estado = "Revisado";

                texto = "Servicio: " + (i + 1)+ "\n"
                        + "Orden del servicio: 000" + jsonArray.getJSONObject(i).getString("id_servicio") + "\n"
                        + "Fecha diagnóstico: " + jsonArray.getJSONObject(i).getString("fecha_diagnostico") + "\n"
                        ...
                        + "Diagnóstico: " + jsonArray.getJSONObject(i).getString("diagnostico") + "\n"
